...
func (m *Manager) UpdateStaticIPStatus(staticIP *v2alpha1.CiliumStaticIP) error {
	_, err := m.StaticIPInterface.CiliumStaticIPs().Update(context.Background(), staticIP, v1.UpdateOptions{})
	if err != nil {
		return err
	}
	return nil
...
func (m *Manager) CreateStaticIP(staticIP *v2alpha1.CiliumStaticIP) error {
	_, err := m.StaticIPInterface.CiliumStaticIPs().Create(context.Background(), staticIP, v1.CreateOptions{})
	if err != nil {
		return err
	}
	return nil
